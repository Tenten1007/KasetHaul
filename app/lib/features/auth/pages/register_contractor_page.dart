...
class RegisterContractorPage extends StatelessWidget {
  final String? phoneNumber;
  final bool phoneVerified;
  const RegisterContractorPage({
    super.key,
    this.phoneNumber,
...
class _RegisterContractorView extends StatefulWidget {
  final String? phoneNumber;
  final bool phoneVerified;
  const _RegisterContractorView({
    this.phoneNumber,
    required this.phoneVerified,
  });

  @override
  State<_RegisterContractorView> createState() =>
      _RegisterContractorViewState();
}

class _RegisterContractorViewState extends State<_RegisterContractorView> {
            ...
            ListTile(
              leading: Container(
                ...
                decoration: BoxDecoration(
                    color: AppConfig.secondaryColor.withAlpha(26),
  ...
  Widget build(BuildContext context) {
    return BlocListener<RegisterBloc, RegisterState>(
      listener: (context, state) {
        if (state is RegisterContractorSuccess) {
          Navigator.of(context).pushAndRemoveUntil(
            MaterialPageRoute(
              builder: (_) => RegisterContractorSuccessPage(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('ลงทะเบียน - ผู้รับจ้าง'),
          elevation: 0,
  ...
  InputDecoration _deco(String hint) => InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(8),
            borderSide:
                const BorderSide(color: AppConfig.secondaryColor, width: 2)),
